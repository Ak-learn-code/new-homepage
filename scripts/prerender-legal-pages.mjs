...
const header = `<header class="nav-shell legal-header"><nav class="nav-pill" aria-label="Hauptnavigation"><a class="nav-logo" href="${asset('#top')}" aria-label="SideTwo Startseite">${logo}</a><div class="nav-links"><a href="${asset('#leistungen')}">Leistungen</a><a href="${asset('#referenzen')}">Projekte</a><a href="${asset('insights/')}">Insights</a></div><a class="nav-contact" href="${asset('#kontakt')}">Kontakt</a></nav></header>`
const footer = `<footer class="footer"><div class="footer-inner"><div class="footer-brand">${footerLogo}<p>Wir bauen digitale Auftritte, Systeme und Automatisierungen, die im Alltag wirklich arbeiten.</p></div><div class="footer-col"><strong>Studio</strong><a href="${asset('#impact')}">Über uns</a><a href="${asset('insights/')}">Insights</a></div><div class="footer-col"><strong>Rechtliches</strong><a href="${asset('impressum')}">Impressum</a><a href="${asset('datenschutz')}">Datenschutz</a></div></div><div class="footer-bottom"><span>© 2026 SideTwo. Alle Rechte vorbehalten.</span><span>Direkt. Klar. Persönlich.</span></div></footer>`
