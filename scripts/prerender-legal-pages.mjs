...
const header = `<header class="nav-shell legal-header"><nav class="nav-pill" aria-label="Hauptnavigation"><a class="nav-logo" href="${asset('')}" aria-label="SideTwo Startseite">${logo}</a><div class="nav-links"><a href="${asset('#leistungen')}">Leistungen</a><a href="${asset('#referenzen')}">Projekte</a><a href="${asset('insights/')}">Insights</a></div><a class="nav-contact" href="${asset('#kontakt')}">Kontakt</a></nav></header>`
