...
function Header() { return <header className="nav-shell legal-header"><nav className="nav-pill" aria-label="Hauptnavigation"><a className="nav-logo" href={home()} aria-label="SideTwo Startseite"><span className="sidetwo-logo" style={logoStyle} /></a><div className="nav-links"><a href={home('#leistungen')}>Leistungen</a><a href={home('#referenzen')}>Projekte</a><a href={asset('insights/')}>Insights</a></div><a className="nav-contact" href={home('#kontakt')}>Kontakt</a></nav></header> }
